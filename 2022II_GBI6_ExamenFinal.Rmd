...
El gráfico también muestra el coeficiente de determinación (\$R\^2\$) en la ecuación de regresión para cada panel, lo que indica la cantidad de variabilidad en la longitud de la aleta que se explica por la masa corporal. En general, el \$R\^2\$ es bastante alto, lo que sugiere que la masa corporal es un predictor bastante bueno de la longitud de la aleta.
